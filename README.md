...
Images and Videos are protected under specified licence (not MIT!). Please check accordingly and provide appropriate credits. 
...
- `forward-message.R` Custom class element. Print out `description` of page's yaml header. See [here](/research/asbiologist.qmd).

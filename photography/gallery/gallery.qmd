...
albums <- yaml.load_file("photography/gallery/albums.yml")
...
#   album$thumbnail <- paste0("../assets/gallery/thumbnails/", album$name, ".jpg") # for photo at local 
    album$thumbnail <- paste0("https://ik.imagekit.io/zzzhehao/gallery/thumbnails/", album$name, ".jpg") # for photo on imagekit
  cat(sprintf('

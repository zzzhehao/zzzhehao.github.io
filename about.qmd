...
Deep-sea Munnopsidae Isopod with fantastic swimming ability can be used as a powerful research object to assess benthic species community and connectivity of deep-sea ecosystems. *Acanthocope spp*, ***is additionally a beautiful genus consisting many recently new discovered species***. With interdisciplinary work being promoted more and more in last years, there's still huge amount of work to do - the genetic data is vastly missing in context of the deep-sea, also for *Acanthocope*. I've started revise some described species with different approach - conventional morphological species description, proteomics fingerprinting analysis, biogeographic analysis cooperating with DNA barcoding techniques. I ask particularly: "**How exactly are the species different from each other? Can we pass our knowledge to non-expert to efficiently and accurately identify known species of this genus?**"
...
## [Ocean Census South Sandwich Islands Expedition 2025]{.cl-title}

Ocean Census are going to Southern Ocean near Antarctica next February, onboard of Schmidt Ocean Institute's R/V Falkor (Too). We will be using ROV SuBastian to collect deep-sea samples around South Sandwich Islands and South Sandwich Trench. The major mission of the biologist onboard is discover unknown species in the deep. 

The ROV is also equipped with live cameras and the real-time footage will be streamed by SOI on [YouTube](https://www.youtube.com/@SchmidtOcean). 

![R/V Falkor (Too) © Schmidt Ocean Institute](https://schmidtocean.org/wp-content/uploads/FalkorToo-Depart-111222-Ingle.jpg)

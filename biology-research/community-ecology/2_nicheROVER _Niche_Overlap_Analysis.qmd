...
By the way, if anyone felt familiar with these penguins and these data -- yes, this is the exact same dataset they used to produce the `palmerpenguins` package, except the isotope data were not included. I found this direcly in [EDI Data Portal](https://portal.edirepository.org/nis/advancedSearch.jsp) and didn't notice until I attached the images, because these three guys showing up at the same time is weirdly familiar to me. 

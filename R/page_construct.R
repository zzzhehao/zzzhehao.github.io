...
#' Insert custom callout left fence
#' 
#' @description
#' Currently a new custom callout is not supported. This work around uses the least used callout .callout-caution to mimic a custom callout. For details see: https://stackoverflow.com/questions/74647399/define-a-new-callout-in-quarto
#' 
#' @param title Title.
